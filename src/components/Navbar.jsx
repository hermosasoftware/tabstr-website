  ...
  return (
    ...
    >
      <div className="2xl:w-[1280px] xl:w-10/12 w-11/12 flex items-center relative">
        ...
        >
          <a href="/#home" aria-label="Tabstr Home">
        ...
        >
          <div className="hidden lg:flex h-full pb-2">
            {navbarLinks.map(({ href, label, ariaLabel }) => (
              <a
                className="text-white lg:text-base text-2xl leading-6 mx-4 2xl:mx-6 cursor-pointer font-normal lg:font-medium hover:scale-110 transition h-full pt-2"
                href={href}
